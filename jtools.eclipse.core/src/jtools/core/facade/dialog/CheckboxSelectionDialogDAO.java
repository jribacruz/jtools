...
public class CheckboxSelectionDialogDAO extends JtCheckboxSelectionDialog<JtModel> {
	...
	public CheckboxSelectionDialogDAO(IProject project, IWorkbenchWindow window) {
		super(window);
