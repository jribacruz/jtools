package jtools.eclipse.core.dialog;
...
public abstract class JtTreeSelectionDialog<T> implements Serializable {
	...
	public JtTreeSelectionDialog(IWorkbenchWindow window) {
		super();
		this.window = window;
	}
