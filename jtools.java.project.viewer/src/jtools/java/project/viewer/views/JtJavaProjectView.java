...
public class JtJavaProjectView extends ViewPart {

	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "jtools.java.project.viewer.views.JtJavaProjectView";
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				JtJavaProjectView.this.fillContextMenu(manager);
			}
		});
	...
	private void showMessage(String message) {
		MessageDialog.openInformation(viewer.getControl().getShell(), "Jtool Java Project View", message);
	}
